...
def getFlightsCancelNum(departDate:str, airportCode:str):
    ...
    Output:
        Int
    """
    airlineData = pd.read_csv(f'code-submission/backend/dataset/{airportCode}_2010_23.csv',sep=',')
    return(airlineData[airlineData["Date"]==departDate]["Canceled_Flights"])

def getFlightCancelPer(date:str, airport:str):
    """
...
def getDataTotData(date:str, airport:str):
    """
